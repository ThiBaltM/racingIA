...
class NeuralNetwork:
    def __init__(self, input_size=None, hidden_size=None, output_size=None, hidden2_size=None, data=None, data2=None):
        noMutateRate = 0.990
        if(data2==None and data==None):
            ...
            self.weights2 = [[random.random() for _ in range(hidden_size)] for _ in range(hidden2_size)]
